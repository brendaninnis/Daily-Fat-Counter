...
extension Color {
    ...
    struct UI {
        ...
        static func gradientStartColor(withProgress progress: Double, inColorScheme colorScheme: ColorScheme) -> Color {
        ...
        static func gradientEndColor(withProgress progress: Double, inColorScheme colorScheme: ColorScheme) -> Color {
